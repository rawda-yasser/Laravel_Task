...
@section('content')
    ...
    <form enctype="multipart/form-data" action="{{ route('posts.update', $post->id) }}"
        ...
        <div class="mb-4">
            ...
            <textarea
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                id="description" name="description" placeholder="Enter post description" v>{{ old() ? old('description') : $post->description }}</textarea>
        </div>
        <div class="mb-4">
