...
@section('content')
    <div class="flex center-center items-center px-8 pt-6 pb-8 mb-4">
        ...
        <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-auto"
            href="{{ route('comments.index', $postId) }}">Back to comments</a>
    ...
    <form enctype="multipart/form-data" action="{{ route('comments.store', $postId) }}"
        ...
        <div class="mb-4">
            ...
            <input
                ...
                id="title" name="title" type="text" placeholder="Enter post title" value="{{ old('title') }}">
        ...
        <div class="mb-4">
            ...
            <textarea
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                id="description" name="description" placeholder="Enter post description">{{ old('description') }}</textarea>
        </div>
        <div class="mb-4">
